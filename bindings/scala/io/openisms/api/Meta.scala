...
final case class Meta(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[Meta] {
    @transient
    ...
    def clearCreated: Meta = copy(created = _root_.scala.None)
    def withCreated(__v: com.google.protobuf.timestamp.Timestamp): Meta = copy(created = Option(__v))
    def withIdentifier(__v: _root_.scala.Predef.String): Meta = copy(identifier = __v)
    def withEtag(__v: _root_.scala.Predef.String): Meta = copy(etag = __v)
    def withUnknownFields(__v: _root_.scalapb.UnknownFieldSet) = copy(unknownFields = __v)
    def discardUnknownFields = copy(unknownFields = _root_.scalapb.UnknownFieldSet.empty)
    def getFieldByNumber(__fieldNumber: _root_.scala.Int): _root_.scala.Any = {
      (__fieldNumber: @_root_.scala.unchecked) match {
        case 1 => created.orNull
        case 2 => {
          val __t = identifier
    ...
    def getField(__field: _root_.scalapb.descriptors.FieldDescriptor): _root_.scalapb.descriptors.PValue = {
      ...
      (__field.number: @_root_.scala.unchecked) match {
        case 1 => created.map(_.toPMessage).getOrElse(_root_.scalapb.descriptors.PEmpty)
        case 2 => _root_.scalapb.descriptors.PString(identifier)
        case 3 => _root_.scalapb.descriptors.PString(etag)
      }
    }
    def toProtoString: _root_.scala.Predef.String = _root_.scalapb.TextFormat.printToUnicodeString(this)
    def companion: io.openisms.api.Meta.type = io.openisms.api.Meta
    // @@protoc_insertion_point(GeneratedMessage[io.openisms.v1.Meta])
}

object Meta extends scalapb.GeneratedMessageCompanion[io.openisms.api.Meta] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[io.openisms.api.Meta] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): io.openisms.api.Meta = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[io.openisms.api.Meta] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      _root_.scala.Predef.require(__fieldsMap.keys.forall(_.containingMessage eq scalaDescriptor), "FieldDescriptor does not match message type.")
      io.openisms.api.Meta(
        created = __fieldsMap.get(scalaDescriptor.findFieldByNumber(1).get).flatMap(_.as[_root_.scala.Option[com.google.protobuf.timestamp.Timestamp]]),
  ...
  lazy val defaultInstance = io.openisms.api.Meta(
    created = _root_.scala.None,
    identifier = "",
    etag = ""
  )
  implicit class MetaLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, io.openisms.api.Meta]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, io.openisms.api.Meta](_l) {
  ...
  def of(
    ...
    identifier: _root_.scala.Predef.String,
    etag: _root_.scala.Predef.String
  ): _root_.io.openisms.api.Meta = _root_.io.openisms.api.Meta(
    created,
    identifier,
    etag
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[io.openisms.v1.Meta])
}
